...
| <a name="input_ubuntu_image"></a> [ubuntu\_image](#input\_ubuntu\_image) | The source image family or self-link for the Ubuntu instance boot disk | `string` | `"ubuntu-os-cloud/ubuntu-2504-amd64"` | no |
| <a name="input_windows_image"></a> [windows\_image](#input\_windows\_image) | The source image family or self-link for the Windows instance boot disk | `string` | `"windows-cloud/windows-2022"` | no |
...
| <a name="input_ubuntu_static_ip"></a> [ubuntu\_static\_ip](#input\_ubuntu\_static\_ip) | Static internal IP address for the Ubuntu instance. If null, an IP is assigned automatically | `string` | `null` | no |
| <a name="input_windows_static_ip"></a> [windows\_static\_ip](#input\_windows\_static\_ip) | Static internal IP address for the Windows instance. If null, an IP is assigned automatically | `string` | `null` | no |
| <a name="input_create_windows_instance"></a> [create\_windows\_instance](#input\_create\_windows\_instance) | Whether to create a Windows compute instance alongside the Ubuntu instance | `bool` | `true` | no |
